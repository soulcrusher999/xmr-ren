...
public class DetailActivity extends AppCompatActivity {
    ...
    private OthersRent post;
    private TextView  roomName , location , price , contact_no , owner_name, bookmark,description;
...
//        title.setText(post.getDesc());
        ...
        bookmark.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                userBookmark.setCategoryName(FilePaths.OTHERS);
    ...
    private void getIncomingIntent() {
        ...
        post = in.getParcelableExtra(mContext.getString(R.string.calling_others_detail));
    ...
    private void confirmDelDialog() {
        ...
        builder.setPositiveButton("Confirm", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                firebaseHelper.getMyRef().child(FilePaths.OTHERS).child(post.getId())
