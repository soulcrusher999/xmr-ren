...
public class HotelsFragment extends Fragment {
    ...
    private List<Hotel> mBookmarkList;
                                ...
                                .addListenerForSingleValueEvent(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                        ...
                                        for (DataSnapshot ds :
                                            ...
                                            for (Hotel hotel :
                                                    mList) {
                                                if (hotel.getId().equals(userBookmark.getPost_id())){
                                                    mBookmarkList.add(hotel);
                                                }
                                            }
    ...
    private void setupAdapter() {
        ...
        adapter = new HotelRecyclerAdapter(mContext, mBookmarkList);
